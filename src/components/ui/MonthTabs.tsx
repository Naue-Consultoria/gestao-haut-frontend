        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {showYearlyTab && (
            <div className="flex gap-1 p-1 bg-gray-100 rounded-[8px]">
              <button
                onClick={() => { if (isYearly) onSelect(0); }}
                className={`px-4 py-2 rounded-[6px] text-xs font-semibold cursor-pointer transition-all duration-300 font-main ${
                  !isYearly
